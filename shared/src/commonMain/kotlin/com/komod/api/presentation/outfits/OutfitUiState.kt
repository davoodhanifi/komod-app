...
data class OutfitUiState(
    ...
    // User override for the fetched weather temperature, entered via the edit icon on the
    // weather card — applied on top of weatherUiState's temperature when generating outfits.
    // Reset whenever a fresh weather fetch starts (see OutfitViewModel.refreshWeather callers).
    val editedTemperatureC: Double? = null,
